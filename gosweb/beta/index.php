...
<td rowspan="2" class="tmain" align="center">
<br><font color="#333333" size="5">Добро пожаловать в Мир!</font><br><br>
Для входа введите свои E-mail и пароль:<br><br>
<table border="0">
<form action="login.php?act=logindone" method="POST" name="f1">
<tr><td align="right" class="b">E-mail: </td><td><input type="Text" name="email" maxlength="50"></td></tr>
<tr><td align="right" class="b">Пароль: </td><td><input type="password" name="pass" maxlength="50"></td></tr>
<tr><td>&nbsp;</td><td><input type="Submit" name="go" value="Войти" style="width: 200 px;"></td></tr>
</form>
</table><br>
