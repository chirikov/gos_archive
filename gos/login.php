...
if($_GET['act'] == "login")
{
	...
	else $body = "<a href='index.php'>Мир</a> - <font class='b'>Вход</font><br><br>".loginform();
}
elseif($_GET['act'] == "logindone")
{
	...
	if($actcode != 0)
	{
		header("Location: registration.php?act=act");
		exit;
	}
	if($passdb != md5($pass))
	{
		$body = "<a href='index.php'>Мир</a> - <font class='b'>Вход</font><br><br><font color='red'>Неверные данные.</font><br><br>";
		$body .= loginform();
	}
	else
	{
